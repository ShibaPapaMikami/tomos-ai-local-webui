const CACHE_NAME = "gemma4-pwa-0.8.236-download-progress";
const APP_SHELL = [
  "/",
  "/mobile.html",
  "/offline.html",
  "/manifest.webmanifest",
  "/styles.css?v=0.8.236-download-progress",
  "/i18n.js?v=0.8.235-strict-purpose",
  ...
  "/asr.js?v=0.8.236-download-progress",
  "/tts.js?v=0.8.236-download-progress",
  ...
  "/models.js?v=0.8.235-strict-purpose",
  ...
  "/pwa.js?v=0.8.236-download-progress",
  "/mobile-standalone.js?v=0.8.209-tomos53",
  "/app.js?v=0.8.236-download-progress",
  "/icons/icon.svg",
  "/icons/icon-192.png",
  "/icons/icon-512.png"
];
