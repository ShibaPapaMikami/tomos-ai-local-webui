const CACHE_NAME = "gemma4-pwa-0.8.197-study-pack-persist1";
const APP_SHELL = [
  "/",
  "/mobile.html",
  "/offline.html",
  "/manifest.webmanifest",
  "/styles.css?v=0.8.197-experimental-toggle4",
  "/i18n.js?v=0.8.197-huihui-composer1",
  "/utils.js?v=0.8.197-japanese-spacing1",
  ...
  "/models.js?v=0.8.197-huihui-composer1",
  "/messages.js?v=0.8.197",
  "/sidebar.js?v=0.8.197",
  "/settings.js?v=0.8.197-huihui-composer1",
  "/management.js?v=0.8.197-study-pack-persist1",
  "/router.js?v=0.8.197",
  "/search.js?v=0.8.197",
  "/pwa.js?v=0.8.197-mobile30",
  "/mobile-standalone.js?v=0.8.197-mobile30",
  "/app.js?v=0.8.197-study-pack-persist1",
  "/icons/icon.svg",
  "/icons/icon-192.png",
  "/icons/icon-512.png"
];
