...
assert.match(indexHtml, /src="\/person-relationship\.js\?v=0\.8\.208-tomos52"/);
assert.match(indexHtml, /src="\/person-name-fortune\.js\?v=0\.8\.208-tomos52"/);
...
assert.match(indexHtml, /src="\/i18n\.js\?v=0\.8\.208-tomos52"/);
assert.match(indexHtml, /href="\/styles\.css\?v=0\.8\.208-tomos52"/);
