...
assert.match(indexHtml, /src="\/person-relationship\.js\?v=0\.8\.209-tomos53"/);
assert.match(indexHtml, /src="\/person-name-fortune\.js\?v=0\.8\.209-tomos53"/);
...
assert.equal(notePack.visibility, "public");
assert.equal(notePack.version, "0.1.0");
