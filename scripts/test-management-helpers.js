...
assert.match(indexHtml, /src="\/i18n\.js\?v=0\.8\.206-tomos5"/);
assert.match(indexHtml, /href="\/styles\.css\?v=0\.8\.206-tomos5"/);
...
assert.match(i18nJs, /"character\.memoryHelp": "マイキャラが覚えていることを確認・編集・削除できます。"/);
