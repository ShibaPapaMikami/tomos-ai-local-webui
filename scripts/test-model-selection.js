...
assert.match(indexSource, /\/i18n\.js\?v=0\.8\.221-note-pack-install/);
...
assert.match(indexSource, /\/management\.js\?v=0\.8\.221-note-pack-install/);
...
assert.match(serviceWorkerSource, /const CACHE_NAME = "gemma4-pwa-0\.8\.221-note-pack-install"/);
assert.match(serviceWorkerSource, /\/i18n\.js\?v=0\.8\.221-note-pack-install/);
...
assert.match(serviceWorkerSource, /\/management\.js\?v=0\.8\.221-note-pack-install/);
