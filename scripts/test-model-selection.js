...
assert.match(indexSource, /\/i18n\.js\?v=0\.8\.206-tomos1/);
assert.match(indexSource, /\/utils\.js\?v=0\.8\.206-tomos1/);
assert.match(indexSource, /\/models\.js\?v=0\.8\.206-tomos1/);
assert.match(indexSource, /\/settings\.js\?v=0\.8\.206-tomos1/);
assert.match(indexSource, /\/management\.js\?v=0\.8\.206-tomos1/);
assert.match(indexSource, /\/app\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /gemma4-pwa-0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/i18n\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/utils\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/models\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/settings\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/management\.js\?v=0\.8\.206-tomos1/);
assert.match(serviceWorkerSource, /\/app\.js\?v=0\.8\.206-tomos1/);
