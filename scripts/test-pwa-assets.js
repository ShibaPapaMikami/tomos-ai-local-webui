...
assert.match(index, /src="\/i18n\.js\?v=0\.8\.222-note-pack-error"/);
...
assert.match(index, /src="\/management\.js\?v=0\.8\.222-note-pack-error"/);
assert.match(index, /src="\/workspace\.js\?v=0\.8\.225-note-no-save"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.226-note-complete"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.226-note-complete"/);
assert.match(sw, /\/styles\.css\?v=0\.8\.221-note-pack-install/);
assert.match(sw, /\/i18n\.js\?v=0\.8\.222-note-pack-error/);
...
assert.match(sw, /\/app\.js\?v=0\.8\.226-note-complete/);
