...
assert.match(index, /src="\/app\.js\?v=0\.8\.223-long-note"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.223-long-note"/);
...
assert.match(sw, /\/app\.js\?v=0\.8\.223-long-note/);
