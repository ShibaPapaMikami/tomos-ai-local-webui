...
assert.match(index, /src="\/i18n\.js\?v=0\.8\.221-note-pack-install"/);
assert.match(index, /src="\/pwa\.js\?v=0\.8\.220-note-article"/);
assert.match(index, /src="\/search\.js\?v=0\.8\.219-searchfix"/);
assert.match(index, /src="\/person-name-fortune\.js\?v=0\.8\.209-tomos53"/);
assert.match(index, /src="\/person-relationship\.js\?v=0\.8\.209-tomos53"/);
assert.match(index, /src="\/sidebar\.js\?v=0\.8\.219-searchfix"/);
assert.match(index, /src="\/management\.js\?v=0\.8\.221-note-pack-install"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.220-note-article"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.221-note-pack-install"/);
assert.match(sw, /\/styles\.css\?v=0\.8\.221-note-pack-install/);
assert.match(sw, /\/i18n\.js\?v=0\.8\.221-note-pack-install/);
assert.match(sw, /\/settings\.js\?v=0\.8\.219-searchfix/);
assert.match(sw, /\/sidebar\.js\?v=0\.8\.219-searchfix/);
assert.match(sw, /\/management\.js\?v=0\.8\.221-note-pack-install/);
assert.match(sw, /\/pwa\.js\?v=0\.8\.220-note-article/);
assert.match(sw, /\/app\.js\?v=0\.8\.220-note-article/);
assert.match(sw, /\/search\.js\?v=0\.8\.219-searchfix/);
assert.match(sw, /\/person-name-fortune\.js\?v=0\.8\.209-tomos53/);
assert.match(sw, /\/person-relationship\.js\?v=0\.8\.209-tomos53/);
assert.match(sw, /cache\.put\(event\.request/);
const pwaJs = fs.readFileSync("web/pwa.js", "utf8");
assert.match(pwaJs, /navigator\.serviceWorker\.register\("\/sw\.js\?v=0\.8\.220-note-article"\)/);
...
assert.match(mobileHtml, /アプリ版 0\.8\.210/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.209-tomos53"/);
...
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.209-tomos53"/);
...
assert.match(resetCacheHtml, /\/\?v=0\.8\.210-ytdiag1&reset=1/);
