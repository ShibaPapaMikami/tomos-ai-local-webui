...
assert.match(index, /href="\/styles\.css\?v=0\.8\.212-local-ai-status"/);
assert.match(index, /src="\/i18n\.js\?v=0\.8\.212-local-ai-status"/);
assert.match(index, /src="\/pwa\.js\?v=0\.8\.211-listground1"/);
...
assert.match(index, /src="\/app\.js\?v=0\.8\.212-local-ai-status"/);
...
assert.match(sw, /gemma4-pwa-0\.8\.212-local-ai-status/);
assert.match(sw, /\/styles\.css\?v=0\.8\.212-local-ai-status/);
assert.match(sw, /\/i18n\.js\?v=0\.8\.212-local-ai-status/);
assert.match(sw, /\/app\.js\?v=0\.8\.212-local-ai-status/);
...
assert.match(pwaJs, /\/sw\.js\?v=0\.8\.211-listground1/);
