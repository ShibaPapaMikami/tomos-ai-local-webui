...
assert.match(index, new RegExp(`src="/pwa\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}"`));
...
assert.match(index, new RegExp(`src="/app\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}"`));
...
assert.match(sw, new RegExp(`/pwa\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}`));
assert.match(sw, new RegExp(`/app\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}`));
...
assert.match(pwaJs, new RegExp(`navigator\\.serviceWorker\\.register\\("/sw\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}"\\)`));
...
assert.match(mobileHtml, new RegExp(`src="/pwa\\.js\\?v=${STUDENT_MODEL_ASSET_VERSION}"`));
...
assert.match(resetCacheHtml, new RegExp(`/\\?v=${STUDENT_MODEL_ASSET_VERSION}&reset=1`));
