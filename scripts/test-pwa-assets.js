...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.207-tomos49"/);
assert.match(index, /src="\/person-name-fortune\.js\?v=0\.8\.207-tomos49"/);
assert.match(index, /src="\/person-relationship\.js\?v=0\.8\.207-tomos49"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.207-tomos49"/);
...
assert.match(sw, /gemma4-pwa-0\.8\.207-tomos49/);
assert.match(sw, /\/person-name-fortune\.js\?v=0\.8\.207-tomos49/);
assert.match(sw, /\/person-relationship\.js\?v=0\.8\.207-tomos49/);
assert.match(sw, /cache\.put\(event\.request/);
const pwaJs = fs.readFileSync("web/pwa.js", "utf8");
assert.match(pwaJs, /\/sw\.js\?v=0\.8\.207-tomos49/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.207-tomos49"/);
...
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.207-tomos49"/);
...
assert.match(resetCacheHtml, /\/\?v=0\.8\.207-tomos49&reset=1/);
