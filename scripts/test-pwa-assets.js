...
assert.match(index, /src="\/app\.js\?v=0\.8\.224-long-note-pipeline"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.224-long-note-pipeline"/);
...
assert.match(sw, /\/app\.js\?v=0\.8\.224-long-note-pipeline/);
