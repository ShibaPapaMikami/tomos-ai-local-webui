...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.196-pwa8"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.196-pwa8"/);
...
assert.match(sw, /mobile-chat-tools-8/);
...
assert.match(mobileHtml, /アプリ版 0\.8\.196/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.196-pwa8"/);
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.196-mobile3"/);
