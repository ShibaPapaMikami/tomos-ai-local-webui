...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.203-mlx18"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.203-mlx18"/);
...
assert.match(mobileHtml, /アプリ版 0\.8\.203/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.203-mlx18"/);
...
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.203-mlx18"/);
...
[
  ...
  assert.match(launcher, /0\.8\.203/, `${path} should use the current app version`);
