...
assert.match(index, /src="\/app\.js\?v=0\.8\.225-note-no-save"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.225-note-no-save"/);
...
assert.match(sw, /\/app\.js\?v=0\.8\.225-note-no-save/);
