...
assert.match(index, /src="\/app\.js\?v=0\.8\.211-listground1"/);
...
assert.match(sw, /gemma4-pwa-0\.8\.211-listground1/);
...
[
  ...
  assert.match(launcher, /0\.8\.213/, `${path} should use the current app version`);
