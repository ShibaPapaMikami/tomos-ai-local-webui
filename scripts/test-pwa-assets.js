...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.198-mlx17"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.198-mlx17"/);
...
assert.match(mobileHtml, /アプリ版 0\.8\.198/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.198-mlx17"/);
...
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.198-mlx17"/);
...
[
  ...
  assert.match(launcher, /0\.8\.198/, `${path} should use the current app version`);
