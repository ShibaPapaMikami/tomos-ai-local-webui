...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.206-tomos48"/);
assert.match(index, /src="\/person-name-fortune\.js\?v=0\.8\.206-tomos48"/);
assert.match(index, /src="\/person-relationship\.js\?v=0\.8\.206-tomos48"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.206-tomos48"/);
...
assert.match(sw, /gemma4-pwa-0\.8\.206-tomos48/);
assert.match(sw, /\/person-name-fortune\.js\?v=0\.8\.206-tomos48/);
assert.match(sw, /\/person-relationship\.js\?v=0\.8\.206-tomos48/);
assert.match(sw, /cache\.put\(event\.request/);
const pwaJs = fs.readFileSync("web/pwa.js", "utf8");
assert.match(pwaJs, /\/sw\.js\?v=0\.8\.206-tomos48/);
...
assert.match(mobileHtml, /アプリ版 0\.8\.206/);
...
assert.match(mobileHtml, /src="\/pwa\.js\?v=0\.8\.206-tomos48"/);
...
assert.match(mobileHtml, /src="\/mobile-standalone\.js\?v=0\.8\.206-tomos48"/);
...
[
  ...
  assert.match(launcher, /0\.8\.206/, `${path} should use the current app version`);
...
assert.match(resetCacheHtml, /\/\?v=0\.8\.206-tomos48&reset=1/);
