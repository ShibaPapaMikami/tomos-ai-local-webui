...
assert.match(index, /href="\/styles\.css\?v=0\.8\.218-final-review"/);
assert.match(index, /src="\/i18n\.js\?v=0\.8\.218-final-review"/);
...
assert.match(index, /src="\/management\.js\?v=0\.8\.220-note-article"/);
...
assert.match(sw, /const CACHE_NAME = "gemma4-pwa-0\.8\.220-note-article"/);
...
assert.match(sw, /\/management\.js\?v=0\.8\.220-note-article/);
