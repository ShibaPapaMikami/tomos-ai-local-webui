...
assert.match(index, new RegExp(`src="/app\\.js\\?v=${CHAT_CONTEXT_ASSET_VERSION}"`));
...
assert.match(sw, new RegExp(`/pwa\\.js\\?v=${CHAT_CONTEXT_ASSET_VERSION}`));
assert.match(sw, new RegExp(`/app\\.js\\?v=${CHAT_CONTEXT_ASSET_VERSION}`));
...
assert.match(pwaJs, new RegExp(`navigator\\.serviceWorker\\.register\\("/sw\\.js\\?v=${CHAT_CONTEXT_ASSET_VERSION}"\\)`));
...
assert.match(mobileHtml, new RegExp(`src="/pwa\\.js\\?v=${CHAT_CONTEXT_ASSET_VERSION}"`));
