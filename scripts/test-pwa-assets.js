...
assert.match(index, /src="\/pwa\.js\?v=0\.8\.219-searchfix"/);
...
assert.match(index, /src="\/management\.js\?v=0\.8\.219-searchfix"/);
assert.match(index, /src="\/app\.js\?v=0\.8\.219-searchfix"/);
...
assert.match(pwaJs, /\/sw\.js\?v=0\.8\.219-searchfix/);
