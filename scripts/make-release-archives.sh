...
copy_common() {
  ...
  copy_if_exists "agent_reach_adapter.py" "$target/"
  copy_if_exists "pdf_reader.py" "$target/"
  copy_if_exists "knowledge_layer.py" "$target/"
  copy_if_exists "context_core.py" "$target/"
  copy_if_exists "contract_ledger.py" "$target/"
  copy_if_exists "sarashina_ocr_runner.py" "$target/"
  copy_if_exists "study_pack_manager.py" "$target/"
  copy_if_exists "packages" "$target/"
